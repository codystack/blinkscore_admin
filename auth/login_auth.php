                        ...
                        <tr>
                            <td style='text-align:center;padding-top:30px;'>
                                <a href='https://my.fastquid.ng'>
                                    <img src='https://res.cloudinary.com/dzow7ui7e/image/upload/v1760563868/BlinksCore-Logo-Horizontal-Dark_br97jk.png' alt='BlinkScore' width='200'>
                                </a>
                            </td>
                        </tr>
                        <tr>
                            <td style='padding:30px 30px 10px 30px;text-align:left;color:#444;'>
                                ...
                                <p style='font-size:14px;margin:0 0 20px;'>A login was just detected on your BlinkScore admin account.</p>
                                ...
                                <p style='font-size:13px;color:#666;margin-top:15px;'>If this was you, no action is required.<br>If not, please reset your password immediately.</p>
                            </td>
                        </tr>
                        <tr>
                            <td style='text-align:center;padding:20px 30px 40px 30px;'>
                                <p style='font-size:12px;color:#aaa;margin-top:20px;'>&copy; " . date('Y') . " BlinkScore. All rights reserved.</p>
                            </td>
                        </tr>
                    </tbody>
                </table>
