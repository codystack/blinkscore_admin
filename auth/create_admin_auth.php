                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style='text-align:center;padding:30px 30px 10px 30px;'>
                                    <h2 style='font-size:22px;color:#333;margin:0;'>Admin Account Created</h2>
                                </td>
                            </tr>
                            <tr>
                                <td style='text-align:center;padding:0 30px 20px 30px;'>
                                    ...
                                    <a href='https://backoffice.blinkscore.ng' style='display:inline-block;margin-top:10px;padding:10px 25px;background:#0E423E;color:#fff;text-decoration:none;border-radius:5px;'>Go to Admin Dashboard</a>
                                </td>
                            </tr>
                            <tr>
