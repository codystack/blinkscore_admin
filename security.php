...
<body>
    <div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
        <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg scrollbar" id="sidebar">
            <div class="container-fluid"><button class="navbar-toggler ms-n2" type="button" data-bs-toggle="collapse" data-bs-target="#sidebarCollapse" aria-controls="sidebarCollapse" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>                <a class="navbar-brand d-inline-block py-lg-2 mb-lg-5 px-lg-6 me-0" href="../../index.html"><img src="../../img/logos/clever-primary.svg" alt="..."></a>
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#sidebar-user" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebar-user"><i class="bi bi-people"></i> User</a>
                            <div class="collapse" id="sidebar-user">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="../user/profile.html" class="nav-link">Profile</a></li>
                                    <li class="nav-item"><a href="../user/table-view.html" class="nav-link">Table View</a></li>
                                    <li class="nav-item"><a href="../user/permissions.html" class="nav-link">Permissions</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item"><a class="nav-link active" href="#sidebar-settings" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebar-settings"><i class="bi bi-gear"></i> Settings</a>
                            <div class="collapse show" id="sidebar-settings">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item"><a href="general.html" class="nav-link">General</a></li>
                                    <li class="nav-item"><a href="security.html" class="nav-link font-bold">Security</a></li>
                    ...
                    <div class="my-4 px-lg-6 position-relative">
                        <div class="dropup w-full"><button class="btn-primary d-flex w-full py-3 ps-3 pe-4 align-items-center shadow shadow-3-hover rounded-3" type="button" data-bs-toggle="dropdown" aria-expanded="false"><span class="me-3"><img alt="..." src="../../img/people/img-profile.jpg" class="avatar avatar-sm rounded-circle"> </span><span class="flex-fill text-start text-sm font-semibold">Tahlia Mooney </span><span><i class="bi bi-chevron-expand text-white text-opacity-70"></i></span></button>
                            <div
                                class="dropdown-menu dropdown-menu-end w-full">
                                <div class="dropdown-header"><span class="d-block text-sm text-muted mb-1">Signed in as</span> <span class="d-block text-heading font-semibold">Tahlia Mooney</span></div>
                                <div class="dropdown-divider"></div><a class="dropdown-item" href="#"><i class="bi bi-house me-3"></i>Home </a><a class="dropdown-item" href="#"><i class="bi bi-pencil me-3"></i>Profile </a><a class="dropdown-item" href="#"><i class="bi bi-gear me-3"></i>Settings</a>
                                <div
                                    class="dropdown-divider"></div><a class="dropdown-item" href="#"><i class="bi bi-box-arrow-left me-3"></i>Logout</a></div>
                </div>
                ...
                <div class="border-bottom pt-6">
                    <div class="row align-items-center">
                        <div class="col-sm-6 col-12">
                            <h1 class="h2 ls-tight">Security</h1>
                        </div>
                    ...
                    <ul class="nav nav-tabs overflow-x border-0">
                        ...
                        <li class="nav-item"><a href="team.html" class="nav-link">Team</a></li>
                        <li class="nav-item"><a href="billing.html" class="nav-link">Billing</a></li>
                        <li class="nav-item"><a href="security.html" class="nav-link active">Security</a></li>
                        <li class="nav-item"><a href="notifications.html" class="nav-link">Notifications</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container-fluid max-w-screen-md vstack gap-6">
                <div class="card">
                    <div class="card-body pb-0">
                        <div class="mb-3 d-flex align-items-center">
                            <h5 class="h4">Two-factor authentication</h5>
                            <div class="ms-auto text-end"><a href="#" class="text-sm font-semibold">Enable</a></div>
                        </div>
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex align-items-center px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 font-semibold mb-1">Authentication app</a><span class="d-block text-sm mb-2">Google auth app</span>
                                    <div class="d-flex mx-n1"></div>
                                </div>
                                <div class="ms-auto text-end"><a href="#" class="btn btn-sm btn-neutral">Setup</a></div>
                            </div>
                            <div class="list-group-item d-flex align-items-center px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 font-semibold mb-1">Primary email</a><span class="d-block text-sm mb-2">E-mail used to send notifications</span>
                                    <div class="d-flex mx-n1"></div>
                                </div>
                                <div class="ms-auto text-end"><a href="#" class="btn btn-sm btn-neutral">Setup</a></div>
                            </div>
                            <div class="list-group-item d-flex align-items-center px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 font-semibold mb-1">SMS Recovery</a><span class="d-block text-sm mb-2">Your phone number or something</span>
                                    <div class="d-flex mx-n1"></div>
                                </div>
                                <div class="ms-auto text-end"><a href="#" class="btn btn-sm btn-neutral">Setup</a></div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body row g-5">
                        <div class="col-md-7">
                            ...
                            <form>
                                <div class="mb-5">
                                    <div><label class="form-label" for="password_current">Current password</label> <input type="password" class="form-control" id="password_current"></div>
                                </div>
                                <div class="mb-5">
                                    <div><label class="form-label" for="password_new">New password</label> <input type="password" class="form-control" id="password_new"></div>
                                </div>
                                <div class="mb-5">
                                    <div><label class="form-label" for="password_confirm">Confirm password</label> <input type="password" class="form-control" id="password_confirm"></div>
                                </div>
                ...
                <div class="card">
                    <div class="card-body pt-8">
                        <div class="mb-3 d-flex align-items-center">
                            <h5 class="h4">Devices</h5>
                            <div class="ms-auto text-end"><a href="#" class="link-danger text-sm font-semibold">Sign out all</a></div>
                        </div>
                        <div class="list-group list-group-flush">
                            <div class="list-group-item d-flex px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 mb-1"><span class="d-inline-block w-7"><i class="bi bi-phone text-base"></i></span>iPhone 11</a>
                                    <p class="text-sm text-muted ms-7">London, UK · Oct 23 at 1:15 AM</p>
                                </div>
                            ...
                            <div class="list-group-item d-flex px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 mb-1"><span class="d-inline-block w-7"><i class="bi bi-laptop text-base"></i></span>Macbook Pro</a>
                                    <p class="text-sm text-muted ms-7">London, UK · Oct 23 at 1:15 AM</p>
                                </div>
                                <div class="ms-auto text-end align-self-center">
                                    <div class="dropdown"><a class="text-muted" href="#" role="button" data-bs-toggle="dropdown" id="dropdownMore2" aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></a>
                                        <div class="dropdown-menu"><a href="#!" class="dropdown-item">Action </a><a href="#!" class="dropdown-item">Another action </a><a href="#!" class="dropdown-item">Something else here</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="list-group-item d-flex px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 mb-1"><span class="d-inline-block w-7"><i class="bi bi-phone text-base"></i></span>iPhone SE</a>
                                    <p class="text-sm text-muted ms-7">London, UK · Oct 23 at 1:15 AM</p>
                                </div>
                                <div class="ms-auto text-end align-self-center">
                                    <div class="dropdown"><a class="text-muted" href="#" role="button" data-bs-toggle="dropdown" id="dropdownMore3" aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></a>
                                        <div class="dropdown-menu"><a href="#!" class="dropdown-item">Action </a><a href="#!" class="dropdown-item">Another action </a><a href="#!" class="dropdown-item">Something else here</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="list-group-item d-flex px-0">
                                <div class="flex-fill"><a href="#" class="d-block h6 mb-1"><span class="d-inline-block w-7"><i class="bi bi-phone text-base"></i></span>Google Pixel 3</a>
                                    <p class="text-sm text-muted ms-7">London, UK · Oct 23 at 1:15 AM</p>
                                </div>
                                <div class="ms-auto text-end align-self-center">
                                    <div class="dropdown"><a class="text-muted" href="#" role="button" data-bs-toggle="dropdown" id="dropdownMore4" aria-haspopup="true" aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></a>
                                        <div class="dropdown-menu"><a href="#!" class="dropdown-item">Action </a><a href="#!" class="dropdown-item">Another action </a><a href="#!" class="dropdown-item">Something else here</a></div>
                                    </div>
                                </div>
                            </div>
                        </div><a href="#" class="btn btn-neutral w-full mt-2">Need help?</a></div>
                </div>
            </div>
        </main>
    </div>
